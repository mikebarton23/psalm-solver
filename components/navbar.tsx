          ...
          <Dialog>
            ...
            <DialogContent className="bg-gray-900 text-white p-4 overflow-y-auto max-h-[85vh] w-full max-w-md">
              ...
              <DialogDescription className="text-white text-md">
                <p className="mb-4">Psalm Solver is a passion project by StealthSnoozer. It's designed to inject a bit of fun and challenge into your day with Bible-related puzzles.</p>
                <p>
